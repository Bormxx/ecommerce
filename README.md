...
2. __Шрифты__
    ...
    - Для хранения шрифтов используется папка `app`, которая лежит в папке `src`
3. __Картинки__
...
7. __Компоненты__
    ...
    - Для валидации компонентов форм исполуется [Zod](https://zod.dev/) и [React Hook Form](https://react-hook-form.com/)
