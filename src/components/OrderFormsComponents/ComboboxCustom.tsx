...
export default function ComboboxCustom({ control, name, openFn }: UseControllerProps<TOrderSchema> & { openFn: Dispatch<SetStateAction<string>>}) {
          ...
          >
            <div className="relative group">
              <ComboboxInput
                ...
                className={cn(
                  inter.className,
                  "font-normal w-[171px] rounded-md border py-[10px] px-3 text-sm",
