...
export default function RadioPaymentField({ id, cardNumber}: RadioPaymentFieldProps) {
  return (
    <Field className="flex items-center gap-2 box-border min-w-[139px]">
      <Radio
        value={id ?? null}
        className="w-full center cursor-pointer rounded-md border border-gray-400 px-4 py-2 outline-1 hover:border-blue-600 hover:text-blue-600 outline-blue-600 data-[checked]:outline data-[checked]:border-blue-600 data-[checked]:text-blue-600 data-[checked]:bg-blue-100/60"
      >
